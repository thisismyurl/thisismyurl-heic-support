<?php
/**
 * Bundled GitHub release updater (per-plugin, namespaced).
 *
 * Polls a GitHub Release for a newer tag and feeds it into WordPress's
 * plugin-update transient. This is a plain per-plugin copy under a unique
 * namespace so two co-installed plugins can't collide; no build tooling.
 *
 * @package ThisIsMyURL\HEIC
 */

namespace ThisIsMyURL\HEIC;
